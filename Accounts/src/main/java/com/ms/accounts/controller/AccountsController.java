...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "get build information being deployed as accounts microservices"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "get java version information being deployed as accounts microservices"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
